...
- Treat `AGENTS.md` as the lightweight default contract for local agent work. Keep detailed optional workflow policy in `docs/architecture/*`.
...
- Agent delivery system decisions: `docs/architecture/2026-03-07-agent-delivery-system-decision.md`, `docs/architecture/2026-04-12-token-efficient-agentic-delivery-decision.md`
